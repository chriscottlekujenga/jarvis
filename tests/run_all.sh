...
run_test "retry command guards" "python3 tests/test_retry_command_guards.py"
run_test "edit targeting" "python3 tests/test_edit_targeting.py"
run_test "task usefulness" "python3 tests/test_task_usefulness.py"
run_test "checkpoint mode" "python3 tests/test_checkpoint_mode.py"
run_test "project creation" "python3 tests/test_project_creation.py"
